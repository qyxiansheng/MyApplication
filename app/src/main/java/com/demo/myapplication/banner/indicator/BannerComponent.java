...
import com.demo.myapplication.banner.viewpager.DurationScroller;
import com.demo.myapplication.banner.viewpager.SViewPager;
...
public class BannerComponent extends IndicatorViewPager {
    ...
    private float oldx, oldy;//拦截左右滑动事件
    ...
    private void initViewPagerScroll() {
        try {
            ...
            //ViewPager类中的成员变量Scroller为private,故必须进行此操作
            mScroller.setAccessible(true);
            scroller = new DurationScroller(
                    viewPager.getContext());
            //修改属性值，代入自定义的DurationScroller，非直接scroller原对象
